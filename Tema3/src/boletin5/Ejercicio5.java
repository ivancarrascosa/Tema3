...
public class Ejercicio5 {
	...
	public static void main(String[] args) {
		...
		System.out.println(Arrays.deepToString(gira90(tabla)));
	...
	public static int[][] gira90(int tablaInicio[][]) {
		...
		// Uso la funcion trnasposición para hacer la transpuesta de la que se me ha introducido
		...
		for (int j = 0 ; j < matrizTranspuesta[0].length ; j++) {
			// Despues paso todos los elementos a la simétrica y es lo mismo que girar 90 grados
