...
public class Ejercicio6 {
	...
	public static void main(String[] args) {
		...
		// Creo un bucle while en el que se genere un número y lo introduzca en el array si el número no está ya en el array
		while (cont <= 5) {
		...
		// Reinicio el bucle y hago lo mismo que en el bucle anterior creando el array de la combinación ganadora
		cont = 0;
		while (cont <= 5) {
			Arrays.sort(ganador);
			numRand = rand.nextInt(1,50);
		...
		// Ordeno el ganador para poder hacer un binary search y voy buscando por cada uno de mi apuesta si coinciden
		Arrays.sort(ganador);
